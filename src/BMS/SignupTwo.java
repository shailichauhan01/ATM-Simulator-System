...
//        add(l14);
        ...
        l12.setBounds(450,70,60,30);
        add(l12);

        l13.setBounds(515,70,60,30);
        add(l13);
        ...
        c1.setBounds(300,120,300,30);
        add(c1);

        l3.setBounds(100,170,100,30);
        add(l3);

        c2.setBounds(300,170,300,30);
        add(c2);

        l4.setBounds(100,220,100,30);
        add(l4);

        c3.setBounds(300,220,300,30);
        add(c3);

        l5.setBounds(100,270,150,30);
        add(l5);

        c4.setBounds(300,270,300,30);
        add(c4);
        ...
        c5.setBounds(300,340,300,30);
        add(c5);

        l7.setBounds(100,390,150,30);
        add(l7);

        t1.setBounds(300,390,300,30);
        add(t1);

        l8.setBounds(100,440,180,30);
        add(l8);

        t2.setBounds(300,440,300,30);
        add(t2);
        ...
        r4.setBounds(400,540,100,30);
        add(r4);

        b.setBounds(500,500,100,25);
        add(b);
