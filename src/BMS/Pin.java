...
public class Pin extends JFrame implements ActionListener{
    ...
    Pin(String pin){
        ...
        l4.setBounds(0, 0, 800, 680);
        add(l4);

        l1 = new JLabel("CHANGE YOUR PIN");
        l1.setForeground(Color.WHITE);
        l1.setFont(new Font("System", Font.BOLD, 16));
        l1.setBounds(235,205,500,35);
        l4.add(l1);
        ...
        l2.setBounds(150,250,120,25);
        l4.add(l2);

        l3.setBounds(150,280,150,25);
        l4.add(l3);

        t1.setBounds(300,250,150,25);
        l4.add(t1);

        t2.setBounds(300,280,150,25);
        l4.add(t2);
